...
数据生成时间：2026-09-23T03:53:21+08:00（北京时间）

AI HOT：34 条；TrendRadar：12 条 AI 相关热点。
实际采集快照：1 个；平台：11 个。
...
### A1｜Artificial Analysis 评测 GPT-6 Sol 和 Luna：成本减半但各评测有升有降
...
### A2｜Anthropic 发布 Claude Opus 5.5：性能对标 Fable 5.1，运行成本比 Opus 5 低 40%
...
### A3｜GPT-6 Sol 和 GPT-6 Luna 上线 Arena，API 定价比 GPT-5.6 促销价低 50%

OpenAI 发布 GPT-6 Sol 和 GPT-6 Luna，基于 GPT-6 Astra 的技术，主打更快、更便宜以支持大规模工作，并优化了缓存和推理效率，API 定价比 GPT-5.6 促销价低 50%。

来源：X：Arena (@arena)；发布时间：2026-09-22T18:48:20Z

原文：https://x.com/arena/status/2102470066784854177
收录页：https://aihot.news/items/cmud15c4p0405ro1fa7kb61fe

### A4｜Sam Altman 称 GPT-6 Sol 和 Luna 按任务定价在市场上没有对手
...
### A5｜OpenAI 发布 GPT-6 Sol 和 GPT-6 Luna，API 价格比 GPT-5.6 促销价低 50%
...
### A6｜OpenAI GPT-6 Sol 和 GPT-6 Luna 上线 OpenRouter
...
### A7｜Artificial Analysis 评测 GPT-6 Sol 与 Luna：成本减半，智能指数持平
...
### A8｜GPT-6 Sol 与 Luna 发布，API 价格比 GPT-5.6 低 50%
...
### A9｜GPT-6 Sol 与 GPT-6 Luna 在 ChatGPT Work 和 Codex 中推送
...
### A10｜OpenAI 发布 GPT-6 Sol 和 GPT-6 Luna，API 价格较 GPT-5.6 降 50%
...
### A11｜Claude Opus 5.5 上架 Arena 的 Agent Arena 与 Battle Mode
...
### A12｜Claude Opus 5.5 登顶 Artificial Analysis 智能指数，得分 58
...
### A13｜Anthropic 发布 Claude Opus 5.5，成本较 Opus 5 降低 40%
...
### A14｜Boris Cherny 实测 Claude Opus 5.5：比 Fable 5.1 快且便宜 51%
...
### A15｜Claude Opus 5.5 上线 OpenRouter，智能体编码等能力领先 Opus 5
...
### A16｜Claude Opus 5.5 登顶 Artificial Analysis Intelligence Index，并降价 20%
...
### A17｜Claude Code v2.1.280 发布，新增 Claude Opus 5.5 为默认 Opus 模型
...
### A18｜Anthropic 发布 Claude Opus 5.5，Claude 5.5 系列首个模型
...
### A19｜Qwen-Image-2.1 开源发布，登顶 Arena 图像编辑榜开源第一
...
### A20｜LiteParse 9 月更新：PDFium 提速 20-25%，新增视觉定位与 is-complex 路由 API
...
### A21｜Meta AI 助手 Muse 曝出严重 0-day，可被本地应用窃取账户令牌
...
来源：Hacker News：AI 热帖；发布时间：2026-09-22T14:35:15Z

原文：https://arstechnica.com/security/2026/09/muse-metas-extraordinarily-privileged-ai-assistant-has-a-serious-0-day
收录页：https://aihot.news/items/cmucwn00k0rgmroed9bjd9g33

### A22｜Apple 新款 Mac mini（M6/M5 Pro）与 Mac Studio（M5 Max/M5 Ultra）今日开售
...
### A23｜Kimi 发布浏览器扩展，由 Kimi WebBridge 更名而来
...
### A24｜卡兹克实测对比 Grok 4.7 与小米 MiMo V2.6：后者成不可能三角版本答案
...
### A25｜Artificial Analysis 评测 Step 5 Preview： Intelligence Index 得 44 分，成本约为同级模型 1/2.8
...
### A26｜OpenRouter 实测 Jev 1.13 与 Claude Opus 5 在 Banking77 分类任务上的准确率、延迟与成本
...
### A27｜OpenRouter 推出 Batch API，批量推理可享半价
...
### A28｜transformers 支持直接加载 GGUF 量化模型，本地推理性能接近 llama.cpp
...
### A29｜OpenRouter 解读 NVIDIA Nemotron 3.5 Lightning 如何承担 Agent 高频执行调用
...
### A30｜小米 MiMo-V2.6-Pro 登上 Code Arena： WebDev 榜约第10名，开源权重中约第3
...
### A31｜小米发布开放权重模型 MiMo-V2.6-Pro，登顶 Artificial Analysis 开放权重模型智能指数
...
### A32｜小米发布 MiMo-V2.6 Pro 与 Flash 全模态开源模型
...
### A33｜小米发布并开源 MiMo-V2.6 系列，扩展强化学习规模迈向自我提升
...
### A34｜不列颠哥伦比亚省起诉 OpenAI，指其未在枪击案前将 flagged ChatGPT 活动转介警方
...
### N5｜AI新的"杀手级应用"出现了？Meta Muse有多火？
...
### N8｜特朗普联大讲话：美国中选后或与伊朗达成协议、油价或大跌，对AI“只鼓励、不限制”
