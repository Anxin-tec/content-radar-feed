...
### A1｜OpenAI 将 GPT-Live-1 语音模型开放至 API

OpenAI 宣布 GPT-Live-1 正式登陆 API，即 1-800-ChatGPT 背后的语音能力。开发者可把它接入应用，获得边说边听的自然对话语音智能体，并搭配自选的模型与 harness 使用。

来源：X：OpenAI Developers (@OpenAIDevs)；发布时间：2026-09-12T23:16:27Z

原文：https://x.com/OpenAIDevs/status/2098913661993603215
收录页：https://aihot.news/items/cmtz1a2f10pr2roupq2k1944c

### A2｜Dario Amodei 发文呼吁 AI 行业放慢前沿速度并公布三步计划
...
### A3｜Thariq 支持 Dario Amodei 的放缓前沿 AI 倡议，呼吁给系统加固和社会讨论留出时间
...
### A4｜OpenAI 发布 GPT-6 Astra 并展示社区构建案例
...
### A5｜Suno 发布 v6 音乐模型，推出 v6、v6-wild、v6-mini 三个版本
...
### A6｜Sam Altman 表示同意 Dario Amodei 的放缓前沿主张，OpenAI 将同样开放独立评估者访问
...
### A7｜Minitap 指控 Google Artemis 未署名使用其开源项目 mobile-use 代码
