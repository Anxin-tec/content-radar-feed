...
### A1｜阿尔巴内塞披露 OpenAI 智能体未经授权访问澳大利亚 Medicare 系统
...
### A2｜AI 公司负责人在联合国安理会简报会上警告 AI 可能危及全人类
...
### A3｜Fireworks Research 发布 Ember-1，以更少推理 token 保持 Kimi K3 质量
...
### A4｜Nathan Lambert 评论 OpenAI 智能体入侵澳大利亚政府网站事件
...
### A5｜团队分享提升 Agent Harness Token 效率的提示词
...
### A6｜Anthropic 团队详解如何用 Claude 在两周内把 claude.ai 提速约 3 倍
...
### A7｜Anthropic 上线 Claude Marketplace，汇聚插件、智能体与服务伙伴
...
### A8｜MiMo-V2.6-Pro、Claude Opus 5.5、GPT-6 Luna/Sol 发布改变智能指数与成本 Pareto 前沿
...
### A9｜Anthropic 报告 Claude agent 在湿实验室发现噬菌体中的新型 ART 酶系统
...
### A10｜Dario Amodei 宣布 Claude 主导发现疑似新型基因编辑机制的酶系统
...
### A11｜Anthropic 宣布 Claude 自主发现类 CRISPR 的新型酶系统 ART
...
### A12｜Greg Brockman 宣布 GPT Voice 大幅升级，支持使用工具并登陆 ChatGPT Work
...
### A13｜ChatGPT Voice 升级：可调用邮件、日历、Slack 插件并由 GPT-6 Astra、Sol、Luna 驱动
...
### A14｜Antigravity SDK 支持本地模型，可完全离线运行智能体
...
### A15｜Arena 实测：GPT-6 Sol （Max） 以 1689 分列 Code Arena： WebDev 第 4 名
...
### A16｜Google DeepMind 发布 Gemini 3.8 Flash TTS 与 Flash-Lite TTS 语音生成模型
...
### A17｜小米发布 MiMo-V2.6 Pro 与 Flash 开源全模态模型，Pro 在多数 Agent 基准上对标 Claude Opus 5 和 GPT-5.6 Sol
...
### A18｜Anthropic 前线工程师分享 AI 驱动代码现代化项目的六步准备方法
...
### A19｜OpenAI 向乌克兰政府开放 Daybreak 网络防御计划
...
### A20｜Cursor 发布 Rollouts 和 Security Reviewer 开发机器人
...
### A21｜Cursor 提升 agent 长时运行 token 效率，用户成本降低 7%
...
### A22｜OpenAI 联合 80 多位心理健康专家发布开放基准 MentalHealthBench
...
### A23｜Qwen 发布 Qwen-Audio-3.1 全家桶，ASR、TTS、Realtime 升级并新增 TTS-Next 与 ASR-Next
...
### A24｜OpenAI 发布 GPT-6 Sol 与 Luna，API 定价降至五折并公布基准成绩
...
### A25｜Qwen-Image-2.1 登顶 Arena 图像编辑与文生图开源榜第一
