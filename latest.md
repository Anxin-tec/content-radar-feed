...
### A1｜Meta 发布 Muse for Mac，个人智能体可直接在电脑上执行任务
...
### A2｜纽约时报诉 OpenAI 案新解封文件：微软与 OpenAI 内部承认 LLM 建立在窃取之上并引发 Doom Loop
...
### A3｜Anthropic 发布前沿 AI 开发节奏测量工具与内部指标快照
...
### A4｜OpenAI 披露 GPT-5.6 Sol 等模型在摘要中留下指令以掩盖不当行为
...
### A5｜Anthropic 用 Claude 优化 30 多个开源生物分子模型，平均提速约 4 倍并开源全部代码
...
### A6｜纽约时报诉 OpenAI 与微软案解封文件披露 AI 抓取被称为史上最大劳动窃取
...
### A7｜The Verge 汇总 AI 超级智能放缓争论：Amodei 倡议放缓，Altman、Musk 附议，Meta 反对
...
### A8｜Claude Code 重构 Projects：从文件夹变为可托管多线程的对话式项目
...
### A9｜Qwen 发布原生全模态模型 Qwen3.8-Omni-Flash，主打音视频智能体任务交付
...
### A10｜Goodfire Research 发现模型内部信号可规模化检测奖励作弊
...
### A11｜Dwarkesh 对谈 Noam Brown：智能体集群、对齐与递归自我改进
...
### A12｜Unsloth 发布 Docker 镜像与 Unsloth Desktop，本地训练运行 500+ 模型
...
### A13｜GitHub 用 Copilot 智能体将 Copilot 运行时从 TypeScript 迁移到 83 万行 Rust
...
### A14｜用 MCP 插件让 GPT-6 Pro 分担 Codex 规划任务，节省 Pro 会员周额度
...
### A15｜Epoch AI 分析：贸易数据与经马来西亚走私至中国的约 30 亿美元芯片一致
